                ...
                <tr>\
                    <td width="50%">\
                        <div class="selector-available">\
                            ...
                            <a href="#" class="selector-chooseall">Seleccionar todas</a>\
                        </div>\
                    </td>\
                    <td>\
                    ...
                    <td width="50%">\
                        <div class="selector-chosen">\
                            ...
                            <div class="selector-filter right">\
                                <p>Materias para la plantilla</p>\
                            </div>\
                            <select multiple="multiple" id="sel2" class="filtered target">\
                            </select>\
                            <a href="#" class="selector-clearall">Eliminar todas</a>\
                        </div>\
                    </td>\
                </tr>\
            </table>',
